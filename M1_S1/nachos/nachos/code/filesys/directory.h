...
class Directory {
  public:
    ...
    char* FindNameForSector(int sector); // Find the name of the file for 
    					 // the given sector

    bool Add(const char *name, int newSector, bool isDirectory);  // Add a file name into the directory
    ...
    void addCurrentDirInfo(int sector);

    void addParentDirInfo(int sector);
